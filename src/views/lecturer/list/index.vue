    ...
    <div>
      <el-table v-loading="ctrl.loading" size="medium" :data="list" stripe border style="width: 100%">
        ...
        <el-table-column
          ...
          width="200">
          <template slot-scope="scope">
            <el-button v-has="'/user/pc/lecturer/view'" type="primary" plain @click="handleProportion(scope.row.id)" size="mini">设置分成</el-button>
            <el-button v-has="'/user/pc/lecturer/view'" type="success" plain @click="handleEdit(scope.row.id)" size="mini">修改</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
