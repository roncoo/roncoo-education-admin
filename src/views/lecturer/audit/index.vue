        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <ul class="list-item-actions">
              <li>
                <el-button v-has="'/user/pc/lecturer/audit/view'" type="warning" plain @click="handleAudit(scope.row)" size="mini">审核</el-button>
                <el-button v-has="'/user/pc/lecturer/audit/view'" type="success" plain @click="handleEdit(scope.row.id)" size="mini">修改</el-button>
              </li>
            </ul>
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleAudit(row) {
      ...
      this.ctrl.dialogTitle = row.lecturerName
