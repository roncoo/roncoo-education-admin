          ...
          <template slot-scope="scope">
            <ul class="list-item-actions">
              <li>
                ...
                <el-button v-has="'/system/pc/msg/view'" type="success" plain @click="handleEdit(scope.row.id)" size="mini">修改</el-button>
                <el-button v-has="'/system/pc/msg/push'" type="success" plain @click="handleSend(scope.row.id)" size="mini">发送</el-button>
              </li>
            </ul>
          </template>
        </el-table-column>
  ...
  methods: {
    ...
    handleEdit(row) {
      ...
      api.msgView({ id: row }).then(res => {
        ...
        this.ctrl.dialogTitle = res.data.msgTitle
