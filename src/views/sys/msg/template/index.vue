          ...
          <template slot-scope="scope">
            <ul class="list-item-actions">
              <li>
                ...
                <el-button v-has="'/system/pc/msg/template/view'" type="success" plain @click="handleEdit(scope.row.id)" size="mini">修改</el-button>
              </li>
            </ul>
          </template>
        </el-table-column>
  ...
  methods: {
    ...
    handleEdit(id) {
      ...
      api.templateView({ id: id }).then(res => {
        ...
        this.ctrl.dialogTitle = res.data.title
