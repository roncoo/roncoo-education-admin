    ...
    <div>
      <el-table v-loading="ctrl.load" size="medium" :data="list" stripe border style="width: 100%">
        ...
        <el-table-column
          ...
          label="操作">
          <template slot-scope="scope">
            <el-button v-has="'/system/pc/sys/role/list'" type="warning" plain @click="handleUserRole(scope.row.id, scope.row.realName)" size="mini">角色</el-button>
            <el-button v-has="'/system/pc/sys/user/password'" type="success" plain @click="handlePassword(scope.row.userNo, scope.row.realName)" size="mini">密码</el-button>
            <el-button v-has="'/system/pc/sys/user/view'" type="success" plain @click="handleEdit(scope.row.id)" size="mini">修改</el-button>
            <el-button type="danger" plain @click="handleDelete(scope.row.id)" size="mini">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
