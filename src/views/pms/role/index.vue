    ...
    <div>
      <el-table v-loading="ctrl.load" size="medium" :data="list" stripe border style="width: 100%">
        ...
        <el-table-column
          ...
          width="270">
          <template slot-scope="scope">
            <el-button v-has="'/system/pc/menu/list'" type="warning" plain @click="handlePms(scope.row.id, scope.row.roleName)" size="mini">设置权限</el-button>
            <el-button v-has="'/system/pc/sys/role/view'" type="success" plain @click="handleEdit(scope.row.id)" size="mini">修改</el-button>
