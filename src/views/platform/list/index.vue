        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <ul class="list-item-actions">
              <li>
                <el-button v-has="'/user/pc/platform/view'" type="success" plain @click="handleEdit(scope.row.id)" size="mini">编辑</el-button>
  ...
  methods: {
    ...
    getPlatform(id, type) {
      ...
      api.platformView({ id: id }).then(res => {
        ...
        if (type === 'edit') {
          this.ctrl.dialogTitle = res.data.clientName
