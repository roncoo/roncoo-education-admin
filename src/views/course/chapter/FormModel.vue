<template>
  <el-dialog :append-to-body="true" :model-value="visible" :title="formModel.id ? '章修改' : '章添加'" width="600px" center align-center @close="onClose" :destroy-on-close="true">
...
<script setup>
  ...
  const rules = {
    ...
    isFree: [{ required: true, message: '不能为空', trigger: 'blur' }]
  }
