      ...
      <el-table v-loading="ctrl.loading" size="medium" :data="list" stripe border style="width: 100%">
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-row v-if="scope.row.target === '_blank'" type="success" plain>新窗口打开</el-row>
          ...
          <template slot-scope="scope">
            <ul class="list-item-actions">
              <li>
                ...
                <el-button v-has="'/system/pc/nav/bar/edit'" type="success" plain @click="handleEdit(scope.row)" size="mini">修改</el-button>
              </li>
            </ul>
          </template>
        </el-table-column>
