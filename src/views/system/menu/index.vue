  ...
  <div class="app-container">
    ...
    <el-table :data="page.list" v-loading="page.loading" :tree-props="{ children: 'childrenList', hasChildren: 'hasChildren' }" border row-key="id">
      ...
      <el-table-column label="操作" width="280">
        <template #default="scope">
          <el-button v-permission="'sys:menu:save'" v-if="scope.row.menuType !== 3" type="success" @click="openFormModal(null, scope.row.id)">新增</el-button>
          <el-button v-permission="'sys:menu:edit'" type="primary" @click="openFormModal(scope.row)">编辑</el-button>
          <el-dropdown>
            <el-button>
              更多操作
            ...
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item @click="handleStatus(scope.row)">
                  <el-button v-permission="'sys:menu:edit'" v-if="scope.row.statusId === 0" type="success">启用</el-button>
                  <el-button v-permission="'sys:menu:edit'" v-if="scope.row.statusId === 1" type="warning">禁用</el-button>
                </el-dropdown-item>
                <el-dropdown-item>
                  <el-button v-permission="'sys:menu:delete'" type="danger" @click="handleDelete(scope.row)">删除</el-button>
                </el-dropdown-item>
              </el-dropdown-menu>
            </template>
          </el-dropdown>
