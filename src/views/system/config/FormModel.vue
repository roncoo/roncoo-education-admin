  ...
  >
    <el-form ref="formRef" :model="formModel" :rules="rules" @submit.prevent>
      <el-form-item prop="configValue">
        ...
        <!-- 枚举类型 -->
        <enum-radio
          v-if="formModel.configKey === 'smsPlatform'"
          v-model="formModel.configValue"
          :enum-name="'SmsPlatformEnum'"
        ></enum-radio>
        <enum-radio
          v-if="formModel.configKey === 'storagePlatform'"
          v-model="formModel.configValue"
          :enum-name="'StoragePlatformEnum'"
        ></enum-radio>
        <enum-radio
          v-if="formModel.configKey === 'vodPlatform'"
          v-model="formModel.configValue"
          :enum-name="'VodPlatformEnum'"
        ></enum-radio>
      </el-form-item>
    </el-form>
    <template #footer>
