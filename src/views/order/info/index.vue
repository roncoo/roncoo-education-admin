    ...
    <el-table v-loading="ctrl.load" border size="medium" :data="list" stripe style="width: 100%">
      ...
      <el-table-column label="课程信息" width="150">
        <template slot-scope="scope">
          ...
          <el-row>【
            <el-button type="text" @click="handleOrderList(scope.row.courseId, scope.row.courseName, 1)">详情</el-button>
            】
          </el-row>
        </template>
      </el-table-column>
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <span v-if="scope.row.channelType === 1" type="success" plain>PC端</span>
        </template>
      </el-table-column>
      <el-table-column label="支付方式 / 价格" width="140">
        <template slot-scope="scope">
          <el-row v-if="scope.row.payType === 1" type="success" plain>微信支付</el-row>
      ...
      <el-table-column
        ...
        <template slot-scope="sett">
          ...
          <el-row v-if="sett.row.orderStatus === 3" type="danger" plain>支付失败</el-row>
