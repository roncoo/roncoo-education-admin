      ...
      <div class="search_bar clearfix">
        <el-form :model="query" inline label-width="80px">
          <el-form-item label="友情名称">
            <el-input v-model="query.linkName" clearable/>
          </el-form-item>
          <el-form-item>
    ...
    <el-table v-loading="page.loading" :data="page.list" border>
      ...
      <el-table-column :width="120" label="跳转方式">
        <template #default="scope">
          <span>{{ getEnumObj('TargetEnum')[scope.row.linkTarget] }}</span>
        </template>
      </el-table-column>
            ...
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item @click="handleStatus(scope.row)">
                  <el-button v-if="scope.row.statusId == 0" plain type="success">启用</el-button>
                  <el-button v-if="scope.row.statusId == 1" plain type="danger">禁用</el-button>
                </el-dropdown-item>
                <el-dropdown-item>
