      ...
      <div class="search_bar clearfix">
        <el-form :model="seekForm" inline label-width="80px">
          <el-form-item label="手机号码">
            <el-input v-model="seekForm.artName" clearable/>
          </el-form-item>
          <el-form-item>
    ...
    <el-table v-loading="tableData.loading" :data="tableData.list" border>
      ...
      <el-table-column label="图片">
        <template #default="scope">
          <img :src="scope.row.artPic" :alt="scope.row.artName" style="height:50px;"/>
        </template>
      </el-table-column>
      <el-table-column label="导航名称" prop="artName"/>
      <el-table-column label="导航地址" prop="artTitle"/>
...
import {articleDelete, articleEdit, articlePage} from '@/api/system.js'
