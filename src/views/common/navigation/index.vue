      ...
      <div class="search_bar clearfix">
        <el-form :model="query" inline label-width="80px">
          ...
          <el-form-item>
            ...
            <el-button v-permission="'website:nav:save'" type="success" @click="openFormModal()">添加</el-button>
          </el-form-item>
        </el-form>
      </div>
    </div>
    <el-table v-loading="page.loading" :data="page.list" border>
      ...
      <el-table-column :width="120" label="跳转方式">
        <template #default="scope">
          <span>{{ getEnumObj('TargetEnum')[scope.row.navTarget] }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column :width="210" fixed="right" label="操作" prop="address">
        <template #default="scope">
          <el-button v-permission="'website:nav:edit'" type="primary" @click="openFormModal(scope.row)">编辑</el-button>
          <el-dropdown>
            <el-button>
              更多操作
            ...
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item>
                  <el-button v-permission="'website:nav:edit'" v-if="scope.row.statusId == 0" type="success" @click="handleStatus(scope.row)">启用</el-button>
                  <el-button v-permission="'website:nav:edit'" v-if="scope.row.statusId == 1" type="danger" @click="handleStatus(scope.row)">禁用</el-button>
                </el-dropdown-item>
                <el-dropdown-item>
                  <el-button v-permission="'website:nav:delete'" type="danger" @click="handleDelete(scope.row)">删除</el-button>
                </el-dropdown-item>
              </el-dropdown-menu>
            </template>
          </el-dropdown>
