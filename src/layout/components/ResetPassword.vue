<template>
  <el-dialog
    ...
    width="600px"
  >
    <el-form ref="ruleForm" :model="form" :rules="rules" class="demo-ruleForm" label-width="100px" size="small">
      <el-form-item label="手 机 号" prop="password">
        <el-input v-model="phone" disabled />
      </el-form-item>
      <div class="form-mobile-group">
        <el-form-item class="form-input auto-width" label="验 证 码" prop="password">
          <el-input v-model="form.code" class="auto-width" placeholder="请输入短信验证码" />
        </el-form-item>
        <code-button :size="'small'" :type="4" style="width: 126px;" />
      </div>
      ...
      <el-form-item label="确认密码" prop="checkPassword" required>
        <el-input v-model="form.checkPassword" placeholder="请再次输入新密码" type="password" />
      </el-form-item>
    </el-form>
